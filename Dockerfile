...
ARG TARGETPLATFORM
ARG MAUTRIX_GMESSAGES_VERSION=0.4.2
RUN DOCKER_ARCH=$(case ${TARGETPLATFORM:-linux/amd64} in \
  ...
  && curl -sL https://github.com/mautrix/gmessages/releases/download/v${MAUTRIX_GMESSAGES_VERSION}/mautrix-gmessages-${DOCKER_ARCH} > /tmp/mautrix-gmessages
